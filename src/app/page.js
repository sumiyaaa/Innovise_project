    ...
    <div className="relative min-h-screen overflow-hidden text-white bg-[#0f172a]">
      ...
      <main className="relative z-10 px-6 py-20 space-y-24">
        ...
        <section className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-wide">Welcome to <span className="text-indigo-400">Innovise</span></h1>
          <p className="text-lg md:text-xl text-gray-300">Empowering Business with Intelligent ServiceNow Solutions</p>
        </section>
        ...
        <section className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="text-gray-300">
            Innovise is a modern IT company delivering enterprise-grade solutions using ServiceNow.
            Our mission is to help businesses streamline workflows, boost productivity, and achieve digital transformation.
          </p>
        </section>
        ...
        <section className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 text-center">
          {[
            { title: "ServiceNow Consulting", desc: "Customized solutions and expert guidance." },
            { title: "ITSM Implementation", desc: "Streamline IT operations and support." },
            { title: "Automation & Workflows", desc: "Automate repetitive tasks and reduce errors." },
          ].map((service, i) => (
            <div key={i} className="bg-white/10 p-6 rounded-xl backdrop-blur-md border border-white/10 hover:bg-white/20 transition">
        ...
        <section className="text-center space-y-4">
          <h2 className="text-3xl font-semibold text-indigo-300">Ready to Innovate?</h2>
          <p className="text-gray-300">Contact us today and discover how Innovise can elevate your business.</p>
          <button className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold px-6 py-3 rounded-full transition">Contact Us</button>
        </section>
      </main>
    </div>
  );
